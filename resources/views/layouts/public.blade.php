...
<head>
    ...
    @if(\App\Models\Setting::getVal('favicon'))<link rel="icon" href="{{ asset('storage/' . \App\Models\Setting::getVal('favicon')) }}">@endif
        ...
        <div class="container nav-wrapper">
            <a href="{{ route('home') }}" class="logo">
                @if(\App\Models\Setting::getVal('logo'))
                    <img src="{{ asset('storage/' . \App\Models\Setting::getVal('logo')) }}" alt="{{ \App\Models\Setting::getVal('site_name', 'Autos Mrini') }}" style="max-height: 100px;">
                @else
