...
@section('title', 'Añadir Modelo')
@section('breadcrumb', 'Gestión / Añadir Modelo')

@section('content')
<div class="page-header" style="margin-bottom: 24px;">
    <h1 class="page-title">Añadir Modelo</h1>
    <p class="page-subtitle">Registra un nuevo modelo de vehículo asociado a una marca.</p>
</div>
...
<form action="{{ route('admin.models.store') }}" method="POST">
    ...
    <div class="card" style="overflow: hidden; background: white;">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div>
                        ...
                        <div class="input-wrapper"><input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Ej: Serie 3, Corolla, Clase A" required></div>
                    </div>
                    <div>
        ...
        <div style="padding: 24px; border-top: 1px solid #e2e8f0; background: #f8fafc; display: flex; justify-content: flex-end; gap: 16px;">
            ...
            <button type="submit" class="btn btn-primary" style="padding:12px 32px;"><i class="icon-save" style="margin-right:8px;"></i> Guardar Modelo</button>
        </div>
    </div>
</form>
@endsection